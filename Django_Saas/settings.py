...
def read_secret(secret_file):
    with open(os.path.join(BASE_DIR, secret_file), 'r') as f:
        secret = f.read().strip()
    return secret
...
SECRET_KEY = read_secret('secretkey.secret')
...
if IN_PRODUCTION == False:
    ...
    'default': {
        ...
        'USER': 'cristiangrey',
        'PASSWORD': read_secret('dbpass.secret'),
...
if IN_PRODUCTION:
    ...
    STATICFILES_DIRS = ['/home/cristiangrey/django/posts/static', '/home/cristiangrey/django/passwordsmanager/static']
...
EMAIL_HOST_PASSWORD = read_secret('emailhostpassword.secret')
